...
class EulerOAuth{
  constructor({secretStore,settingsStore,shell,port=48731}={}){this.secretStore=secretStore;this.settingsStore=settingsStore;this.shell=shell;this.port=port;this.pending=null;this.refreshPromise=null;}
