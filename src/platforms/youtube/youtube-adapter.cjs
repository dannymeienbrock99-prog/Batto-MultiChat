...
class YouTubeAdapter extends EventEmitter{
  constructor({oauth}={}){super();this.platform="youtube";this.oauth=oauth;this.videoId="";this.liveChatId="";this.connected=false;this.timer=null;this.pageToken="";this.seen=new Set();}
